                    ...
                    {showMessage.password ? (
                      <FormControl.HelperText ml={3} mt={1}>
                        ...
                        <Icon ml={3} mt={1} size="5" viewBox="0 0 50 50">
                          ...
                          {errors.password
                            ? <FormControl.HelperText ml={2} mt={1} ><Text fontFamily={"Regular"} fontSize="sm">Password</Text></FormControl.HelperText>
                            : <FormControl.ErrorMessage ml={2} mt={2}><Text fontFamily={"Regular"} fontSize="sm">
                    ...
                    <HStack >
                        <Icon ml={3} mt={1} size="5" viewBox="0 0 50 50">
                          ...
                          {errors.confirmPassword
                            ? <FormControl.HelperText ml={2} mt={1} ><Text fontFamily={"Regular"} fontSize="sm">{formData.confirmPassword
                              ? "Confirm Password"
                              : "Please confirm your password"}</Text></FormControl.HelperText>
                            : <FormControl.ErrorMessage ml={2} mt={2}><Text fontFamily={"Regular"} fontSize="sm">
