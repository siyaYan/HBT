        ...
        <Tab.Screen
          ...
          options={{
            ...
            tabBarButton: ({ accessibilityState, onPress }) => (
              ...
              >
                <SvgXml
                  xml={homeSvg(accessibilityState.selected ? "#49a579" : "#191919")}
                  width={30}
                  height={30}
                />
              </TouchableOpacity>
        ...
        />
          ...
          options={{
            ...
            tabBarButton: ({ accessibilityState, onPress }) => (
              ...
              >
                <SvgXml
                  xml={circleSvg(accessibilityState.selected ? "#49a579" : "#191919")}
                  width={30}
                  height={30}
                  top={0}
                />
        ...
        <Tab.Screen
          ...
          options={{
            ...
            tabBarButton: ({ accessibilityState, onPress }) => (
              ...
              >
                <SvgXml
                  xml={uploadSvg(accessibilityState.selected ? "#49a579" : "#191919")}
                  width={30}
                  height={30}
                  top={0}
                />
         ...
         <Tab.Screen
          ...
          options={{
            ...
            tabBarButton: ({ accessibilityState, onPress }) => (
              ...
              >
                <SvgXml
                  xml={settingsSvg(accessibilityState.selected ? "#49a579" : "#191919")}
                  width={30}
                  height={30}
                  top={0}
                />
